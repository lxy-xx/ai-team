...
├── agent-workspace/
│   ├── agents/<Agent>/                  # 运行时 Agent 配置：prompt、tools、output contract、.agents/skills、MCP、memory、traces
│   └── framework/
